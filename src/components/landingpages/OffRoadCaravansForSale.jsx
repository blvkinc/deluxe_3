...
const features = [
  ...
  { icon: 'fa-solid fa-bolt', title: 'Lithium Battery Options', desc: 'XP-TECH’s off-grid power systems available - 1 x 400Ah lithium battery, 4 x 200W solar panels as standard.' },
...
const faqs = [
  ...
  { q: 'What is included at handover?', a: 'Handover includes a full walkthrough of the water system, electrical, off road and off grid setup, all operating manuals, a plumber checked inspection sign off, and all standard accessories. The handover typically takes 2 to 3 hours. A full handover checklist is available on request before you sign.' },
  ...
  return (
    <div className="lp-page">
      <Helmet>
        ...
        <meta name="description" content="Browse Deluxe Caravans' off road range, Australian made in Campbellfield VIC. Composite frame, airbag suspension(Ready), full off-grid power. Book a video call today." />
      ...
      <div className="lp-hero">
        ...
        <div className="lp-hero-inner">
          <p className="lp-hero-eyebrow">
           ...
           OFF ROAD · Australian Made · FOR SALE IN CAMPBELLFIELD VIC
          </p>
      ...
      <div className="lp-section lp-section--panel">
        ...
        <div className="lp-reveal" style={{ marginTop: '40px', textAlign: 'center' }}>
          <p className="lp-section-body" style={{ marginBottom: '16px' }}>Browse all off road models</p>
      ...
      <div className="lp-section lp-section--panel">
        <div className="lp-two-col">
          ...
          <div className="lp-reveal lp-reveal-d2">
            <p className="lp-eyebrow"><span className="lp-eyebrow-line" />17 years, same factory</p>
            <h2 className="lp-section-title">Built in Campbellfield. Warrantied across Australia.</h2>
            <p className="lp-section-body">Deluxe Caravans has been building off road caravans in our Campbellfield, Victoria factory for 17 years. Same team, same address, same standard.</p>
            <br />
