...
const TechspecEclipse18 = () => {
  ...
  const images = useMemo(() => {
    return [
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/kilogram.webp", 'TareWeight', 'Tare Approx: 2350kg'),
...
export default React.memo(TechspecEclipse18);
