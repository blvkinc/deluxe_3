...
const Techspec19xptech = () => {
  ...
  const images = useMemo(() => {
    return [
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/kilogram.webp", 'Bespokemodels', 'Tare Approx: 2500kg'),
      ...
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/length.webp", 'Ratings', 'External Length: 8550mm'),
...
export default React.memo(Techspec19xptech); 