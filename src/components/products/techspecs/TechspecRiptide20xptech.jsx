...
const TechspecRiptide20xptech = () => {
  ...
  const images = useMemo(() => {
    return [
      ...
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/aim%20(1).webp", 'Ratings', 'Ball Approx: 180kg'),
...
export default React.memo(TechspecRiptide20xptech);
