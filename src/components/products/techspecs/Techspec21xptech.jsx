...
const Techspec21xptech = () => {
  ...
  const images = useMemo(() => {
    return [
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/kilogram.webp", 'Bespokemodels', 'Tare Approx: 2650kg'),
      ...
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/length.webp", 'Ratings', 'External Length: 8850mm'),
...
export default React.memo(Techspec21xptech); 