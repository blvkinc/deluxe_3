...
const TechspecRiptide206 = () => {
  ...
  const images = useMemo(() => {
    return [
      animatedImage("https://deluxcaravan.b-cdn.net/assets/techspec/kilogram.webp", 'Bespokemodels', 'Tare Approx: 2880kg'),
...
export default React.memo(TechspecRiptide206);
