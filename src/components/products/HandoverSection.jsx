      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        <div style={{ marginBottom: '48px' }}>
          <p style={{
            ...
            <span style={{ display: 'inline-block', width: '24px', height: '1px', background: 'var(--color-accent)', flexShrink: 0 }} />
            Day of handover
          </p>
          <h2 style={{
          ...
          <p style={{ fontSize: '16px', color: 'var(--color-muted)', lineHeight: '1.7', maxWidth: '640px' }}>
        ...
        <div style={{
          ...
          {checklist.map((item, i) => (
            <div key={i} style={{
              ...
              <div>
                <div style={{ fontSize: '14px', fontWeight: 600, color: 'var(--color-white)', marginBottom: '4px' }}>{item.title}</div>
                <div style={{ fontSize: '13px', color: 'var(--color-muted)', lineHeight: '1.55' }}>{item.detail}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          >
            ...
            <span style={{ color: 'var(--color-accent)', fontSize: '20px', fontWeight: 300, transition: 'transform 0.3s', transform: open ? 'rotate(45deg)' : 'none' }}>+</span>
          </button>
          {open && (
            <div style={{ padding: '0 24px 20px', fontSize: '14px', color: 'var(--color-muted)', lineHeight: '1.75' }}>
