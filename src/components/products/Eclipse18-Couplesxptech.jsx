...
const Eclipse18CouplesXPTech = () => {
  ...
  useEffect(() => {
    window.fbq("track", "ViewContent", { content_name: "Eclipse 18 Couples XP-Tech", content_category: "Caravan" });
  }, []);
    ...
    <div className="container">
      ...
      <div className="slideshowcomopnent" id="layout">
        <EnhancedGallery
          ...
          productName={"Eclipse 18'6\" XP-Tech"}
        />
      </div>
...
export default React.memo(Eclipse18CouplesXPTech);
