...
import Strombreaker23xpteccarousel from "../mobile-carousels/Strombreaker23xpteccarousel";
  ...
  return (
    <>
      ...
      <div className="mobile-div">
        <Strombreaker23xpteccarousel />
      </div>
    </>
  );
}

export default Strombreaker23xptec;
